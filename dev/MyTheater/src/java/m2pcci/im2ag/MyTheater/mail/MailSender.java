package m2pcci.im2ag.MyTheater.mail;
...
public class MailSender {
    ...
    public static void sendMail(Session session, String from, String to, String subject, String messageBody) throws MessagingException{
        // créee un message avec l'expéditeur et le destinataire du message
        Message message = new MimeMessage(session);
        message.setFrom(new InternetAddress(from));
        message.setRecipients(Message.RecipientType.TO,
