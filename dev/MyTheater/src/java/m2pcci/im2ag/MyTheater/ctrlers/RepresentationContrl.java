...
public class RepresentationContrl extends HttpServlet {
@Resource(name = "jdbc/SPEC")
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Representation Rep = MyTheaterDAO.getRep(dataSource, nospectacle,request.getParameter("date"));
    ...
    try {
        ...
        Logger.getLogger(RepresentationContrl.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
